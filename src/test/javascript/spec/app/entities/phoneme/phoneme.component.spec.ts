...
import { PhonemeComponent } from 'app/entities/phoneme/phoneme.component';
import { PhonemeService } from 'app/entities/phoneme/phoneme.service';
import { Phoneme } from 'app/shared/model/phoneme.model';

describe('Component Tests', () => {
  describe('Phoneme Management Component', () => {
    let comp: PhonemeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PhonemeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.phonemes && comp.phonemes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

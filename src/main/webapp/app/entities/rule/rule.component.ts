...
export class RuleComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.ruleService
      ...
      .subscribe(
        (res: HttpResponse<IRule[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInRules(): void {
    this.eventSubscriber = this.eventManager.subscribe('ruleListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IRule[] | null, headers: HttpHeaders, page: number): void {

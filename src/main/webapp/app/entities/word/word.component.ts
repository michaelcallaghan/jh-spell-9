...
export class WordComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.wordService
      ...
      .subscribe(
        (res: HttpResponse<IWord[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInWords(): void {
    this.eventSubscriber = this.eventManager.subscribe('wordListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IWord[] | null, headers: HttpHeaders, page: number): void {

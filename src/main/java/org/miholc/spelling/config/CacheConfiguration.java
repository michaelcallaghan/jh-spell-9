package org.miholc.spelling.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.miholc.spelling.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.miholc.spelling.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, org.miholc.spelling.domain.User.class.getName());
            createCache(cm, org.miholc.spelling.domain.Authority.class.getName());

...
//        annotation = new Annotation("Kosgi Santosh has a hatred of people who are late. He was disappointed that the client kept him waiting.");
        annotation = new Annotation("Michael Callaghan doesn't support Keir Starmer. He thinks that Starmer is not a socialist.");
    }
